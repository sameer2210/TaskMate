                      ...
                      >
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="relative group">
                            ...
                            <div className="absolute right-0 top-8 bg-white rounded-lg shadow-lg border border-slate-200 py-2 w-48 opacity-0 group-hover:opacity-100 transition-opacity z-10">

...
export default function ActivityPage() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 px-6 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 bg-white/80 backdrop-blur-sm border border-slate-200/50 rounded-3xl shadow-xl overflow-hidden flex flex-col">
        {/* Card Header */}
        <div className="bg-gradient-to-r from-teal-50 to-emerald-950 px-8 py-6 flex-shrink-0">
            ...
            >
              ...
              <div className="space-y-4">
                {logs.map((log, index) => (
                  <div
                    key={log._id || log.id}
                    className="group relative bg-gradient-to-r from-slate-50 to-white border border-slate-100 rounded-2xl py-4 px-8 hover:shadow-lg hover:border-emerald-200 transition-all duration-300 hover:scale-[1.01]"
                  >
                    {/* Activity Indicator */}
